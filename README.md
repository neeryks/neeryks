...
<p align="center">
  <img src="https://skillicons.dev/icons?i=react,ts,js,html,css,tailwind,python,nodejs,linux,docker,git,github,vscode&theme=dark" alt="Tech stack icons" />
</p>
...
| [chartmaker](https://github.com/neeryks/chartmaker) | Python / data | chart generation and visualization experiments |
| Solar PV anomaly detection | IoT / ML | sensor cleaning, rule detection, ML anomaly scoring, and event logs |
...
- Build systems that a real business can actually use.
